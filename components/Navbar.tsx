                    ...
                    {isSearching ? (
                      ...
                      <CommandGroup>
                        {searchResults.map((perfume) => (
                          <CommandItem
                            key={perfume._id}
                            onSelect={() => handleSearchSelect(perfume._id)}
                  ...
                  {user ? (
                    <>
                      ...
                      <Button
                        ...
                        className="text-lg text-gray-700 dark:text-gray-300 hover:text-purple-600 transition-colors duration-300 py-2 border-b border-gray-200 dark:border-gray-700 text-left"
                        variant="ghost"
                      >
                        Logout
                      </Button>
